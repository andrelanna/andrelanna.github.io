...
a) Dois objetos instanciados através do método construtor padrão terão o mesmo estado e, portanto, suas referências serão iguais. 
    Falso, dois objetos instanciados pelo construtor padrão terão o mesmo estado mas nunca a mesma referência. “Dois objetos instanciados através do método construtor padrão terão o mesmo estado, mas suas referências não serão iguais.”

b) Uma classe pode ter apenas um método construtor alternativo para instanciação de seus objetos. 
    Falso, uma classe pode ter vários construtores para instanciar os objetos. “Uma classe pode ter vários métodos construtores alternativos para instanciação de seus objetos.”
...
c) Retenção de estados é uma propriedade do paradigma OO que permite aos objetos manterem os valores de seus atributos até o momento em que um estímulo externo ao objeto solicite uma alteração no valor de algum atributo.
	Falso, o estímulo precisa ser interno ao objeto, normalmente utilizando os métodos Setters. “Retenção de estados é uma propriedade do paradigma OO que permite aos objetos manterem os valores de seus atributos até o momento em que um estímulo externo ao objeto solicite uma alteração no valor de algum atributo.”

d) Em Java, o operador . (ponto) serve para acessar somente os métodos de um objeto. 
	Falso, o operador ‘.’ (ponto) serve para acessar todos os elementos do objeto. “Em Java, o operador . (ponto) serve para acessar os métodos e os atributos de um objeto.”
...
e) Métodos destrutores são aqueles métodos que são chamados explicitamente pelo algoritmo para destruir objetos e liberar os espaços que eles ocupam em memória. Em Java métodos destrutores são implementos com o nome **finalize()** e definidos em cada classe.
	Falso, o método finalize() é chamado pelo coletor de lixo, e não deve ser chamado explicitamente pelo algoritmo. “Métodos destrutores são aqueles métodos que são chamados implicitamente pelo algoritmo para destruir objetos e liberar os espaços que eles ocupam em memória. Em Java métodos destrutores são implementos com o nome finalize() e definidos em cada classe.”
...
| +distancia:double             |
|:------------------------------|
| +aumentar_vertical():void     |
| +diminuir_vertical():void     |
| +aumentar_horizontal():void   |
| +diminuir_horizontal():void   |
| +iniciar_gravacao():void      |
| +interromper_gravacao():void  |
| +diminuir_geral():void        |
|:------------------------------|
...
R.:
objeto q1 -> q1.a1 = 0, q1.a2 = 0.0, q1.a3 = null, q1.a4 = false.
objeto q2 -> q2.a1 = 0, q2.a2 = 0.0, q2.a3 = null, q2.a4 = false.
objeto q3 -> q3.a1 = 1, q3.a2 = 1.0, q3.a3 = “null”, q3.a4 = false. 
